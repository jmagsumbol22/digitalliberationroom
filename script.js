...
// ─── MATRIX PAGES (library effect active here) ────────────────────
const MATRIX_PAGES = new Set([
  'page-1', 'page-2', 'page-3', 'page-3a',
...
function goTo(pageId) {
  if (pageId === 'page-4')                           target.left   = 1;
  if (pageId === 'page-5')                           target.right  = 1;
  if (pageId === 'page-6a' || pageId === 'page-6b') target.center = 1;
